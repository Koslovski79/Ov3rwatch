...
def run_backup(args) -> None:
    """Create a zip backup of the Ov3rwatch home directory."""
    hermes_root = get_default_hermes_root()

    if not hermes_root.is_dir():
        print(f"Error: Ov3rwatch home directory not found at {hermes_root}")
        sys.exit(1)
...
def _validate_backup_zip(zf: zipfile.ZipFile) -> tuple[bool, str]:
    """Check that a zip looks like a Ov3rwatch backup.
    ...
    if not found:
        return False, (
            "zip does not appear to be a Ov3rwatch backup "
...
def run_import(args) -> None:
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if (has_config or has_env) and not args.force:
            print()
            print("Warning: Target directory already has Ov3rwatch configuration.")
        ...
        print("Done. Your Ov3rwatch configuration has been restored.")
