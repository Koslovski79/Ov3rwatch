...
TIPS = [
    ...
    "Ctrl+Z suspends Ov3rwatch to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Ov3rwatch itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Ov3rwatch home directory.",
    ...
    "hermes gateway install sets up Ov3rwatch as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Ov3rwatch tools programmatically — results stay out of context.",
    ...
    "When exiting, Ov3rwatch prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Ov3rwatch runs on 18 platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, email, and more.",
    ...
    "BlueBubbles brings iMessage to Ov3rwatch via a local macOS server.",
    ...
    "Ov3rwatch loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Ov3rwatch as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Ov3rwatch your own.",
    ...
    "Before a gateway session reset, Ov3rwatch auto-flushes important facts to memory in the background.",
