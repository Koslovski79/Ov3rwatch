"""Helpers for loading Ov3rwatch .env files consistently across entrypoints."""
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    already knows all valid Ov3rwatch env-var names and can split
...
def load_hermes_dotenv(
    *,
    ...
    """Load Ov3rwatch environment files with user config taking precedence.
