"""Slash command definitions and autocomplete for the Ov3rwatch CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Ov3rwatch config/state", "Session",
    ...
    CommandDef("update", "Update Ov3rwatch Agent to the latest version", "Info",
               gateway_only=True),
