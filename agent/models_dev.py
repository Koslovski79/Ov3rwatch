...
# ---------------------------------------------------------------------------
# Provider ID mapping: Ov3rwatch ↔ models.dev
# ---------------------------------------------------------------------------

# Ov3rwatch provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Ov3rwatch (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Ov3rwatch provider ID to its models dict from models.dev.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Ov3rwatch provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Ov3rwatch ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Ov3rwatch or models.dev provider ID.  Tries exact match then
