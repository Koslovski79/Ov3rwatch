...
# Minimum context length required to run Ov3rwatch Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Ov3rwatch from probing-down to
        ...
        with httpx.Client(timeout=3.0) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Ov3rwatch grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Ov3rwatch sends to providers:
