"""
Timezone-aware clock for Ov3rwatch.
...
Invalid timezone values log a warning and fall back safely — Ov3rwatch never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Ov3rwatch requires 3.9+)
