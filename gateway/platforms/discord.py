...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Ov3rwatch session")
        ...
        @tree.command(name="status", description="Show Ov3rwatch session status")
        ...
        @tree.command(name="stop", description="Stop the running Ov3rwatch agent")
        ...
        @tree.command(name="update", description="Update Ov3rwatch Agent to the latest version")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Ov3rwatch session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Ov3rwatch in the thread",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Ov3rwatch session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Ov3rwatch: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Ov3rwatch"
        if len(content) > 80:
