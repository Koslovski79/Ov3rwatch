...
version: 1.0.0
author: arceus77-7, enhanced by Ov3rwatch Agent
license: MIT
metadata:
  hermes:
...
- `tmux` available for stable authenticated sessions during Ov3rwatch terminal calls (desktop app flow only)
...
### Service Account (recommended for Ov3rwatch)
...
## Ov3rwatch Execution Pattern (desktop app flow)

Ov3rwatch terminal commands are non-interactive by default and can lose auth context between calls.
