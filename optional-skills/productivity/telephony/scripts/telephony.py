#!/usr/bin/env python3
"""Telephony helper for the Ov3rwatch optional telephony skill.
...
def _load_root_config() -> dict[str, Any]:
    ...
    if not path.exists():
        return {}
    try:
        import yaml  # optional dependency; Ov3rwatch already ships PyYAML
    except Exception:
        return {}
    try:
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Ov3rwatch telephony helper")
