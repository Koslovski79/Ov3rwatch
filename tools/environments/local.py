...
# Ov3rwatch-internal env vars that should NOT leak into terminal subprocesses.
...
def _sanitize_subprocess_env(base_env: dict | None, extra_env: dict | None = None) -> dict:
    """Filter Ov3rwatch-managed secrets from a subprocess environment."""
    try:
...
def _find_bash() -> str:
    ...
    raise RuntimeError(
        "Git Bash not found. Ov3rwatch Agent requires Git for Windows on Windows.\n"
