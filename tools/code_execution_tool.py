...
Lets the LLM write a Python script that calls Ov3rwatch tools via RPC,
...
"""Auto-generated Ov3rwatch tools RPC stubs."""
...
"""Auto-generated Ov3rwatch tools RPC stubs (file-based transport)."""
...
def execute_code(
    ...
    to a subset of Ov3rwatch tools.
...
def build_execute_code_schema(enabled_sandbox_tools: set = None) -> dict:
    ...
    description = (
        "Run a Python script that can call Ov3rwatch tools programmatically. "
