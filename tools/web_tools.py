...
When available, Ov3rwatch can route Firecrawl calls through a Nous-hosted tool-gateway
...
def _get_firecrawl_client():
    ...
    Ov3rwatch falls back to the Firecrawl tool-gateway for logged-in Nous Subscribers.
    """
