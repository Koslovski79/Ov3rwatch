...
This module provides the glue:
    - ``Ov3rwatchTokenStorage``: persists tokens/client-info to disk so they
    ...
    mcp_servers:
      my_server:
        ...
        oauth:                                  # all fields optional
          ...
          client_name: "My Custom Client"       # default: "Ov3rwatch Agent"
"""
...
# ---------------------------------------------------------------------------
# Ov3rwatchTokenStorage -- persistent token/client-info on disk
# ---------------------------------------------------------------------------


class Ov3rwatchTokenStorage:
    ...
    class _Handler(BaseHTTPRequestHandler):
        def do_GET(self) -> None:  # noqa: N802
            ...
            body = (
                ...
                "<p>You can close this tab and return to Ov3rwatch.</p></body></html>"
            ) if code else (
...
def remove_oauth_tokens(server_name: str) -> None:
    ...
    storage = Ov3rwatchTokenStorage(server_name)
    storage.remove()
...
def build_oauth_auth(
    ...
    # --- Client metadata ---
    client_name = cfg.get("client_name", "Ov3rwatch Agent")
    scope = cfg.get("scope")
