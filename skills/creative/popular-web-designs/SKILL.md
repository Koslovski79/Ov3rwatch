...
version: 1.0.0
author: Ov3rwatch Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
Each template includes a **Ov3rwatch Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Ov3rwatch notes -->
