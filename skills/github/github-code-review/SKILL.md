...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from Ov3rwatch Agent\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Ov3rwatch Agent. Code looks clean — good test coverage, no security concerns."
